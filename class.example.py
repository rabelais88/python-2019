# Classes and objects
# creating a class which inherits from the default "object" class
class MyRouter(object):
    def __init__(
        self, routername, model, serialno, ios
...
print(router1.model)  # accessing the object's attributes; result is '2600'
...
router2 = MyRouter( "test", "2222", "333", "444")

got = getattr(router2, "ios")  # getting the value of an attribute
print(got)

changed = setattr(router2, "ios", "12.1")  # setting the value of an attribute
print(changed)
